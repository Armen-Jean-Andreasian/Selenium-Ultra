...
class NoSuchChromeExecutable(WebDriverException):
    """New custom error thrown when binary chrome.exe target doesn't exist """
...
class NoSuchElementException(WebDriverException):
    ...
    If you encounter this exception, you may want to check the following:
        ...
        * Element may not yet be on the screen at the time of the find operation,
          (webpage is still loading) see custom_selenium.webdriver.support.wait.WebDriverWait()
