...
from selenium_ultra.custom_selenium.common import WebDriverException
...
class SeleniumManager:
    ...
    def get_binary() -> Path:
        ...
        file = "custom_selenium-manager.exe" if directory == "windows" else "custom_selenium-manager"
