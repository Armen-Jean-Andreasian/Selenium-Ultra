...
from selenium_ultra.custom_selenium.webdriver.common.by import By
from selenium_ultra.custom_selenium.webdriver.common.options import BaseOptions
from selenium_ultra.custom_selenium.webdriver.common.print_page_options import PrintOptions
from selenium_ultra.custom_selenium.webdriver.common.timeouts import Timeouts
from selenium_ultra.custom_selenium.webdriver.common.virtual_authenticator import Credential
from selenium_ultra.custom_selenium.webdriver.common.virtual_authenticator import VirtualAuthenticatorOptions
from selenium_ultra.custom_selenium.webdriver.common.virtual_authenticator import (
    required_virtual_authenticator,
)
from selenium_ultra.custom_selenium.webdriver.support.relative_locator import RelativeBy
...
def import_cdp():
    global cdp
    if not cdp:
        cdp = import_module("custom_selenium.webdriver.common.bidi.cdp")
...
def get_remote_connection(capabilities, command_executor, keep_alive, ignore_local_proxy=False):
    from selenium_ultra.custom_selenium.webdriver.chrome.remote_connection import ChromeRemoteConnection

    candidates = [ChromeRemoteConnection]
