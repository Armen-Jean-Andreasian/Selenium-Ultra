...
from selenium_ultra.custom_selenium.webdriver.common.utils import keys_to_typing
...
class WebElement(BaseWebElement):
    ...
    def get_dom_attribute(self, name) -> str:
        ...
        :func:`~custom_selenium.webdriver.remote.BaseWebElement.get_attribute`, this
    ...
    def get_attribute(self, name) -> str | None:
        ...
        use :func:`~custom_selenium.webdriver.remote.BaseWebElement.get_dom_attribute` or
        :func:`~custom_selenium.webdriver.remote.BaseWebElement.get_property` methods respectively.
    ...
    @property
    def id(self) -> str:
        """Internal ID used by custom_selenium.
